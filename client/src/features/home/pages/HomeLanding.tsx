  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        <PageTitle title="Hey, I'm Freddie" />

        <section className="text-center space-y-6">
          <div className="space-y-6 text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed text-left sm:text-center">
            <p>
              Hi, I’m a product manager at Wise who’s slightly obsessed with how people can interact with AI to
              make their life easier. I'm learning lots about conversational flows and search quirks to agentic
              systems. This site is my playground for building and learning how to develop AI assistants from
              scratch.​
            </p>
            <p>
